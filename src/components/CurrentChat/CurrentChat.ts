      ...
      iconButtons: [
        {
          ...
          target: 'addUser',
          svg:
            '<svg width="22" fill="#40375C" height="22" encoding="UTF-8"?><svg enable-background="new 0 0 512 512"  version="1.1" viewBox="0 0 512 512" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path d="m491.84 156.43c-19.471-45.946-51.936-85.013-92.786-112.64-40.838-27.624-90.162-43.797-143.06-43.79-35.254-2e-3 -68.946 7.18-99.571 20.158-45.945 19.472-85.013 51.935-112.64 92.785-27.624 40.836-43.798 90.161-43.791 143.06-2e-3 35.255 7.181 68.948 20.159 99.573 19.471 45.946 51.937 85.013 92.786 112.64 40.838 27.624 90.162 43.797 143.06 43.79 35.253 2e-3 68.946-7.18 99.571-20.158 45.945-19.471 85.013-51.935 112.64-92.785 27.625-40.837 43.798-90.163 43.791-143.06 2e-3 -35.256-7.181-68.948-20.159-99.573zm-31.428 185.83c-16.851 39.781-45.045 73.723-80.476 97.676-35.443 23.953-78.02 37.926-123.94 37.933-30.619-2e-3 -59.729-6.218-86.255-17.454-39.781-16.851-73.724-45.044-97.677-80.475-23.955-35.442-37.929-78.02-37.936-123.94 2e-3 -30.62 6.219-59.731 17.454-86.257 16.851-39.781 45.045-73.724 80.476-97.676 35.443-23.954 78.021-37.927 123.94-37.934 30.619 2e-3 59.729 6.218 86.255 17.454 39.781 16.85 73.724 45.044 97.677 80.475 23.953 35.443 37.927 78.02 37.934 123.94-2e-3 30.619-6.218 59.73-17.453 86.256z"/><path d="m389.59 239.3h-116.9v-116.9c0-9.222-7.477-16.699-16.699-16.699s-16.699 7.477-16.699 16.699v116.9h-116.9c-9.222 0-16.699 7.477-16.699 16.699s7.477 16.699 16.699 16.699h116.9v116.9c0 9.222 7.477 16.699 16.699 16.699s16.699-7.477 16.699-16.699v-116.9h116.9c9.222 0 16.699-7.477 16.699-16.699s-7.476-16.699-16.699-16.699z"/></svg>',
        },
        // {
        ...
        // },
        {
          ...
          target: 'deleteChat',
          svg:
            '<svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="11" cy="11" r="10.25" stroke="#40375C" stroke-width="1.5" /></svg>',
        },
      ],
    });
