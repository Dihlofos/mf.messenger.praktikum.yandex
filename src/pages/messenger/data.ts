...
import { RenameFormProps } from '../../components/RenameForm/RenameForm.js';
...
export const messengerData: {
  ...
  toptooltipData: TooltipProps;
  bottomtooltipData: TooltipProps;
  chatData: ChatProps;
  renameFormData: RenameFormProps;
} = {
  searchFieldData: {
    name: 'search',
    type: 'text',
    ...
    iconButtons: [
      {
        name: 'Переименовать',
        svg:
          '<svg width="22" height="19" viewBox="0 0 22 19" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="22" height="1.5" transform="matrix(1 0 0 -1 0 19)" fill="#40375C" /><path fill-rule="evenodd" clip-rule="evenodd" d="M16.2602 0L19.0001 2.73982L16.9452 4.79468L14.2054 2.05487L16.2602 0ZM13.5202 2.73976L16.26 5.47958L6.7394 15.0002H4V12.26L13.5202 2.73976Z" fill="#40375C" />/svg>',
      },
      {
        name: 'Удалить',
        svg:
